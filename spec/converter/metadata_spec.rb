...
EOH
    ...
    context 'with halite_use_gem_dependencies' do
      let(:gem_metadata) { {'halite_use_gem_dependencies' => 'true'} }
...
EOH
    end # /context with halite_use_gem_dependencies

    context 'with a chef_version and halite_use_gem_dependencies' do
      let(:gem_metadata) { {'halite_chef_version' => '>= 0', 'halite_use_gem_dependencies' => 'true'} }
...
chef_version ">= 0" if defined?(chef_version)
EOH
    end # /context with a chef_version and halite_use_gem_dependencies
